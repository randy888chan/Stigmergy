...
program
  ...
  .argument('[goal]', 'The high-level development goal to orchestrate.', 'Create a simple portfolio site with React and a contact form.')
  .action(async (goal) => {
    ...
    if (isSystemHealthy) {
      ...
      console.error('Please review the errors above. The system may have attempted to auto-repair some issues.');
      process.exit(1);
    }
  });
