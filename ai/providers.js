...
// *** THE FIX: Converted from module.exports to named exports for ESM ***
...
export function systemPrompt() {
  ...
  return `You are an expert researcher. Today is ${now}. Follow these instructions when responding...`; // Content is the same
}
