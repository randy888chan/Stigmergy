...
agent:
  ...
  core_protocols:
    - "INTELLIGENCE_GATHERING_PROTOCOL: I gather comprehensive context from multiple sources including code intelligence, research tools, and lightweight_archon services."
