...
agent:
  ...
  core_protocols:
    ...
    - "DELEGATION_PROTOCOL: Once the team is selected, I will use the stigmergy.task tool with the chosen agents to create and manage a specialized sub-project to achieve the goal."
