...
const Dashboard = () => {
  ...
  // --- 1. RESTORED: WebSocket Listener ---
  useEffect(() => {
    if (data) {
      setIsConnected(true);
      const { type, payload } = data;
      console.log(`[WS] Received: ${type}`, payload); // Observability Log
      ...
      switch (type) {
        ...
        case 'project_switched':
          // Refresh file list if server tells us context switched
            ...
            <ResizablePanelGroup direction="vertical">
                 ...
                 <ResizablePanel defaultSize={40} className="bg-black">
                    <Suspense fallback={null}>
                        {/* RESTORED: Passing necessary props to ChatInterface */}
                        <ChatInterface
