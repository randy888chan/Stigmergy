...
class AgentPerformance {
  ...
  async initialize() {
    try {
      ...
      console.warn("[AgentPerformance] Failed to initialize metrics directory:", error.message);
      // Continue without metrics tracking if initialization fails
    }
  }
  ...
  async recordTaskCompletion(task) {
    try {
      ...
      console.warn("[AgentPerformance] Failed to record task completion:", error.message);
      return null;
    }
  }
  ...
  async _updateIndex(metrics) {
    try {
      ...
      console.warn("[AgentPerformance] Failed to update index:", error.message);
    }
  }
  ...
  async getAgentMetrics(agentId) {
    try {
      ...
      console.warn("[AgentPerformance] Failed to get agent metrics:", error.message);
      return null;
    }
  }
  ...
  async getBestAgentForTask(taskType) {
    try {
      ...
      console.warn("[AgentPerformance] Failed to get best agent for task:", error.message);
      return null;
    }
  }
  ...
  async getPerformanceInsights() {
    try {
      ...
      console.warn("[AgentPerformance] Failed to get performance insights:", error.message);
      return [];
    }
  }
}
